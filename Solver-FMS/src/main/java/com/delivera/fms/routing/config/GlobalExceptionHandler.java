...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleFileNotFound(NoSuchFileException ex) {
        ...
        return buildResponse(HttpStatus.NOT_FOUND, "Not Found", "Instance file not found: " + ex.getFile());
    }

    @ExceptionHandler(IOException.class)
    public ResponseEntity<Map<String, Object>> handleIOException(IOException ex) {
        log.error("IO error: {}", ex.getMessage(), ex);
        return buildResponse(HttpStatus.INTERNAL_SERVER_ERROR, "IO Error", "Error reading instance file");
    }
